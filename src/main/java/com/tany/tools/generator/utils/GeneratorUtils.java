...
import com.tany.tools.generator.model.ColumnEntity;
import com.tany.tools.generator.model.TableEntity;
...
public class GeneratorUtils {
    ...
    public static String getFileName(String template, String className, String packageName) {
        ...
        if (template.contains("Mapper.xml.vm")) {
            return "resources" + File.separator + packageName.replace('.', File.separatorChar) + File.separator
    ...
    public static void main(String[] args) {
        System.out.println(WordUtils.capitalizeFully("userName", new char[]{'_'}));
    }
}
